...
# Etape 2 : installation MLST program et Docker comme préconisé par la documentation officielle

# Etape 3 : vérifications des répertoires et fichiers
 # Vérifier l'existence du script Outils/resfinder/lancement_resfinder.zsh qui permet d'automatiser l'analyse des fichiers
...
# Etape 2 : se placer dans le répertoire Outils/resfinder (à adapter selon l'appareil)
pwd 
cd /Users/marinepottier/Outils/resfinder

# Etape 3 : 
copier tous les fichiers d'intérêt (fasta ou fastq) dans /resfinder/input

# Etape 4 (facultative) : pour obtenir l'aide 
zsh lancement_resfinder.zsh -h
  ## flags OBLIGATOIRES
